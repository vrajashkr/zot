...
# HAProxy configured to run in SSL-passthrough mode
...
@test "Check for successful zb run on haproxy frontend" {
    zb_run "cloud-scale-out-high-scale-bats" "https://127.0.0.1:8000" 50 100 "${ZOT_AUTH_USER}:${ZOT_AUTH_PASS}"
}
